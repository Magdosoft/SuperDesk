...
class NewsMLOneFeedNewParser(XMLFeedParser):
    """
    ...
    def parse(self, xml, provider=None):
        ...
        try:
            ...
            item['body_html'] = etree.tostring(
                xml.find('NewsItem/NewsComponent/NewsComponent/ContentItem/DataContent/nitf/body/body.content'),
...
register_feed_parser(NewsMLOneFeedNewParser.NAME, NewsMLOneFeedNewParser())