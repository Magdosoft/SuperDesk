...
export function SearchParametersTop($location, asset, tags, metadata, common, desks,
    ...
    return {
        ...
        templateUrl: asset.templateUrl('apps/search/views/search-parametersTop.html'),
